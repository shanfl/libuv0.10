...
@REM @rem Look for Visual Studio 2019
@REM if not defined VS160COMCOMNTOOLS goto vc-set-2013
@REM if not exist "%VS160COMCOMNTOOLS%\..\..\VC\Auxiliary\Build\vcvarsall.bat" goto vc-set-2013
@REM call "%VS160COMCOMNTOOLS%\..\..\VC\Auxiliary\Build\vcvarsall.bat"
@REM echo "111111111111111"
@REM set GYP_MSVS_VERSION=2019
@REM goto select-target
...
echo git clone https://github.com/chromium/gyp.git build/gyp
git clone https://github.com/chromium/gyp.git build/gyp
